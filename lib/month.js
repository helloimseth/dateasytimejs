...
Month.prototype.numDays = function () {
  days = datEasyTime.Util.MONTH_INFO[this.ord].days;

  if (this.monthOrd === 2 && datEasyTime.Util.isALeapYear(this.year)) {
    days += 1;
  }
...
Month.prototype.name = function () {
  return datEasyTime.Util.MONTH_INFO[this.ord].name;
};
